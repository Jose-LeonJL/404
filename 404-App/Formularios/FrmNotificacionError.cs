...
{
    public partial class FrmNotificacionError : Form
    {
        //Variables
        ...
        public FrmNotificacionError(string Mensaje)
        {
            InitializeComponent();
        ...
        public void showAlert()
        {
            ...
            for (int i = 1; i <= 10 - 1; i++)
            {
                ...
                FrmNotificacionError frm = (FrmNotificacionError)Application.OpenForms[fname];
                if (frm is null)
                {
                    Name = fname;
