...
namespace DVStudio.SDK.clases
{
    public class Inventario
    {
        ...
        public static async Task<Response_General> Update_Inventario(Struct_Inventario Inventario, string token, string id)
        {
        ...
        public static async Task<Response_General> Delete_Inventario( string id, string token)
        {
